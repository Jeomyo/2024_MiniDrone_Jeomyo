...
while true
    ...
    if isempty(stats)
        ...
        imshow(img);
        hold on;
        plot(centroid(1), centroid(2), 'b*', 'MarkerSize', 15);
        plot(centerX, centerY, 'b*', 'MarkerSize', 15);
        line([centerX centroid(1)], [centerY centroid(2)], 'Color', 'yellow', 'LineWidth', 2);
        text(10, 10, ['Blue Pixels: ' num2str(blue_pixel_sum)], 'Color', 'yellow', 'FontSize', 12);
